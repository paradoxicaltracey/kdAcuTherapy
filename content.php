    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <?php if ( is_search() || !is_single() ) : // Only display Excerpts for Search ?>
            <div class="entry-summary">
               <?php if ( of_get_option('blogtemexcerptlength', true) != '') { ?>              
                 <p><?php echo wp_trim_words( get_the_content(), of_get_option('blogtemexcerptlength'), '' ); ?></p>
               <?php } else { ?>
               <p><?php the_excerpt(); ?></p>
               <?php } ?>
        ...
        <?php else : ?>
            <div class="entry-content">
                <?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'skt-yogi-pro' ) ); ?>
                <?php
                    wp_link_pages( array(
                        'before' => '<div class="page-links">' . __( 'Pages:', 'skt-yogi-pro' ),
                        'after'  => '</div>',
                    ) );
                ?>
            </div><!-- .entry-content -->
