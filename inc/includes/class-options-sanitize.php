...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-yogi-pro' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-yogi-pro' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-yogi-pro' ),
		'repeat'    => __( 'Repeat All', 'skt-yogi-pro' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-yogi-pro' ),
		'top center'    => __( 'Top Center', 'skt-yogi-pro' ),
		'top right'     => __( 'Top Right', 'skt-yogi-pro' ),
		'center left'   => __( 'Middle Left', 'skt-yogi-pro' ),
		'center center' => __( 'Middle Center', 'skt-yogi-pro' ),
		'center right'  => __( 'Middle Right', 'skt-yogi-pro' ),
		'bottom left'   => __( 'Bottom Left', 'skt-yogi-pro' ),
		'bottom center' => __( 'Bottom Center', 'skt-yogi-pro' ),
		'bottom right'  => __( 'Bottom Right', 'skt-yogi-pro')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-yogi-pro' ),
		'fixed'  => __( 'Fixed in Place', 'skt-yogi-pro')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-yogi-pro' ),
		'italic'      => __( 'Italic', 'skt-yogi-pro' ),
		'bold'        => __( 'Bold', 'skt-yogi-pro' ),
		'bold italic' => __( 'Bold Italic', 'skt-yogi-pro' )
		);
